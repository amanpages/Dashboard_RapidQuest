...
import { getSalesGrowthRate } from '../../services/apiService';
...
const SalesGrowthRate = () => {
    ...
    useEffect(() => {
        const fetchDataAndRenderChart = async () => {
            try {
                const response = await getSalesGrowthRate();
                ...
                if (Array.isArray(response)) {
                    ...
                    response.forEach(item => {
                        ...
                        const growthRate = item.growthRate !== null ? item.growthRate : 0; 
                    ...
                    chartRef.current = new Chart(canvasRef.current, {
                        ...
                        options: {
                            ...
                            plugins: {
                                ...
                                title: {
                                    display: true,
                                    text: `Sales Growth Rate Over Time (${chartType.charAt(0).toUpperCase() + chartType.slice(1)} Chart)`
                                }
                            },
